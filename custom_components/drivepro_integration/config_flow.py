...
from .api import (
    DriveproIntegrationApiClient,
    DriveproIntegrationApiClientAuthenticationError,
    DriveproIntegrationApiClientCommunicationError,
    ...
    async def async_step_user(
        ...
        if user_input is not None:
            try:
                ...
                _errors["base"] = "auth"
            except DriveproIntegrationApiClientCommunicationError as exception:
